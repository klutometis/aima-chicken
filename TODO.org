* TODO Documentation!
  ...
  #+BEGIN_SRC scheme :tangle doc.scm
    ...
    (define tex-procedure
      "\\item[Procedure] \\texttt{(@PROCEDURE@@ARGUMENTS@) $\\to$ @TO@}")
    ...
    (define (descriptions-and-normal-and-special-parameters doc)
      (let ((descriptions (filter string? doc))
        ...
        (let ((normal-parameters
          ...
          (values descriptions normal-parameters special-parameters))))
