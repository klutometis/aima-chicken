* TODO Optional debugging environments.
  Can either have no-op environments that we graft in; or some other mechanism.
* TODO Debugging should really show what action the agent took and the state of the world.
